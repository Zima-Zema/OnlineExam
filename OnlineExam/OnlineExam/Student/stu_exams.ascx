...
<asp:Panel ID="pl_stud_Exam" runat="server" Width="670px">
    <asp:GridView ID="gv_StudentExam" runat="server" AutoGenerateSelectButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
